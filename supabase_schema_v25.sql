-- ═══════════════════════════════════════════════════════════════════
--  PokéVault v25 — Supabase Schema
--  Run this in: Supabase Dashboard → SQL Editor → New Query
--
--  ⚠️  DESTRUCTIVE — drops all existing PokéVault tables first.
--      Run this once to get a clean slate for v25.
--
--  CHANGES vs v18:
--    • Schema version bumped to v25 (matches app release)
--    • No structural changes — all fixes are in app.js / pokeprice.js
--      (saveShareSettings upsert→update, includeEbay param forwarding)
...
--    1. Deploy pokevault-v25 to Vercel (git push → auto-deploy)
...
--         EBAY_APP_ID           — eBay Developer AppID (graded chart)
